-- Enforce semantic write authorization before mutation or replay reconciliation.
-- RLS remains authoritative, while this guard prevents a read-authorized viewer
-- from reaching exact-replay logic and receiving a write-shaped success result.
