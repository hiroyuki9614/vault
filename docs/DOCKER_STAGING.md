...
The checked-in Dockerfiles currently pin release tags:
...
- Apache and Node share an internal edge network; only Node also joins the egress network needed for Supabase.
